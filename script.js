...
const translations = {
  en: {
    ...
    'apps.text': 'Discover Atomic Boom, published on the Google Play Store.',
    'apps.status': 'Available now',
    'apps.item': 'Atomic Boom',
    'apps.category': 'Chemistry game',
    'apps.description': 'A game of chemistry knowledge and agility: identify the elements, progress through the stages, and reach the highest score.',
    'apps.tag_chemistry': 'Chemistry',
    'apps.tag_android': 'Android',
    'apps.download': 'Get it on Google Play',
    'apps.privacy': 'Privacy',
    'apps.license': 'Licenses',
    'apps.coming_soon': 'Coming soon',
    'apps.attracto_crash': 'Attracto Crash',
    'apps.attracto_category': 'Game in development',
    'apps.attracto_description': 'A new game currently in development. More details will be available soon.',
    'apps.upcoming_title': 'Coming Soon - Apps on the Play Store',
    'apps.upcoming_text': 'New adventures are coming.',
  ...
  pt: {
    ...
    'apps.text': 'Conheça o Atomic Boom publicado na Google Play Store.',
    'apps.status': 'Disponível agora',
    'apps.item': 'Atomic Boom',
    'apps.category': 'Jogo de química',
    'apps.description': 'Um jogo de conhecimento de química e agilidade: identifique os elementos, avance pelos estágios e alcance a maior pontuação.',
    'apps.tag_chemistry': 'Química',
    'apps.tag_android': 'Android',
    'apps.download': 'Baixar na Google Play',
    'apps.privacy': 'Privacidade',
    'apps.license': 'Licenças',
    'apps.coming_soon': 'Em breve',
    'apps.attracto_crash': 'Attracto Crash',
    'apps.attracto_category': 'Jogo em desenvolvimento',
    'apps.attracto_description': 'Um novo jogo atualmente em desenvolvimento. Em breve haverá mais detalhes.',
    'apps.upcoming_title': 'Em breve - Aplicativos na Play Store',
    'apps.upcoming_text': 'Novas aventuras estão por vir.',
