...
const translations = {
  en: {
    ...
    'apps.text': 'Discover my game published on the Google Play Store.',
  ...
  pt: {
    ...
    'apps.title': 'Launcher - Aplicativos na Play Store',
    'apps.text': 'Conheça meu jogo publicado na Google Play Store.',
